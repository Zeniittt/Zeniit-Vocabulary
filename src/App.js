...
const initialDictionary = {
  ...
  "identify": ["nhận ra", "nhận dạng", "xác nhận"],
  ...
  "brave": ["can đảm"],
  "bravely": ["dũng cảm"],
  "punetually = punctually": ["đúng giờ"],
  "promote (v) = promotion (n)": ["khuyến mãi", "khuyến khích", "thăng tiến", "quảng bá", "thúc đẩy"],
  ...
  "charger": ["sạc"],
  "reliable = trusted = trustworthy": ["đáng tin cậy"],
  "typical": ["đặc trưng"],
  "typically": ["tiêu biểu"],
  ...
  "persue": ["theo đuổi"],
  "brochure": ["cuốn sách nhỏ", "tập quảng cáo", "tờ rơi"],
  "accurate": ["chính xác"],
  "inquire": ["hỏi"],
  "evaluate": ["đánh giá"],
  ...
  "accompany": ["đồng hành"],
  "carry": ["mang"],
  "replacement = outplacement": ["sự thay thế"],
  ...
  "as soon as": ["sớm nhất", "càng sớm càng", "ngay khi"],
  ...
  "vice president = vice chair": ["phó chủ tịch"],
  "a need": ["nhu cầu"],
  ...
  "thoroughly": ["hoàn toàn", "triệt để", "kỹ lưỡng"],
  "helpful": ["hữu ích"],
  ...
  "blossom": ["hoa"],
  "business": ["việc kinh doanh", "kinh doanh", "doanh nghiệp"],
  "breeze": ["làn gió nhẹ"],
  "intuitive": ["trực quan"],
  "seamless": ["liền mạch"],
  "hassle": ["rắc rối"],
  "hassle free": ["không gặp rắc rối"],
  "Whether you": ["Cho dù bạn"],
  "simplify": ["đơn giản hoá"],
  "backing": ["ủng hộ", "hỗ trợ"],
  "magnetic": ["từ tính"],
  "stripe": ["dọc"],
  "magnetic stripe reader": ["đầu đọc thẻ từ"],
  "emporium": ["cửa hàng bách hoá"],
  ...
  "fiber": ["chất xơ"],
  "A sole table": ["Một cái bàn duy nhất"],
  "recruit": ["tuyển dụng"],
  ...
  "receipt": ["biên lai"],
  "payable": ["phải trả"],
  "eligible": ["đạt tiêu chuẩn", "đủ điều kiện"],
  ...
  "commend": ["khen ngợi"],
  "credited": ["đã ghi nhận"],
  "praise": ["khen", "ca ngợi"],
  "packing slip": ["phiếu đóng gói"],
  "cruet": ["cái lọ"],
  "extra virgin": ["siêu nguyên chất"],
  "bottle": ["cái chai"],
  "tin": ["thiếc"],
  "shipment": ["vận chuyển", "lô hàng"],
  "determined": ["xác định"],
  "restock": ["bổ sung"],
  "peak": ["cao điểm", "đỉnh cao"],
  "compliment": ["khen ngợi", "lời khen"],
  "finest": ["tốt nhất"],
  "marionette = puppet": ["con rối"],
  "beloved": ["được yêu mến"],
  "ballet": ["múa ba lê"],
  "handcraft": ["thủ công"],
  "puppeteer": ["người điều khiển rối"],
  "minions": ["những tay sai"],
  "enthrall": ["say mê"],
  ...
  "allocate": ["phân bổ"],
  "moving forward": ["trong tương lai", "tiến về phía trước"],
  "respondent": ["người được hỏi", "người trả lời"],
  ...
  "centerpiece": ["trung tâm", "tâm điểm"],
  "apart": ["riêng biệt", "khác biệt"],
  "barely": ["hầu như không có"],
  "relief": ["sự cứu tế"],
  "stuck": ["mắc kẹt"],
  "juggle": ["tung hứng"],
  "illustrious": ["nổi tiếng", "lẫy lừng"],
  "nearby": ["gần bên", "gần đó"],
  "competency": ["năng lực"],
  "resolution": ["giải pháp", "quyết định"],
  "Even so": ["Mặc dù vậy"],
  "next to": ["kế bên", "ở cạnh"],
  "pertain": ["liên quan"],
  "magnitude": ["kích cỡ", "độ lớn"],
  "quake": ["động đất"],
  "Meanwhile": ["Trong khi đó"],
  "tasked with": ["chịu trách nhiệm", "có nhiệm vụ"],
  ...
  "hike": ["chuyến đi bộ dài"],
  "surplus = excess": ["thặng dư"],
  "revival": ["sự hồi sinh"],
  "reveal": ["tiết lộ"],
  "behalf": ["thay mặt"],
  "upkeep": ["bảo trì"],
  ...
  "closely": ["chặt chẽ"],
  "put in": ["đưa ra"],
  "set off = set out  ư": ["khởi hành"],
  "contemporary": ["đương đại", "hiện đại", "đồng thời"],
  ...
  "intimidation": ["sự đe doạ"],
  "intimidate": ["khiếp sợ", "đe doạ"],
  "bully": ["bắt nạt"],
  ...
  "burden": ["gánh nặng"],
  "critique": ["phê bình"],
  "enormous": ["lớn lao", "khổng lồ"],
  "capitalizing on": ["khai thác", "tận dụng"],
  "sharply": ["đột ngột"],
  "outcome": ["kết quả"],
  ...
  "upset": ["lo lắng", "buồn bã", "tức giận"],
  "robbed": ["bị cướp"],
  "unethical = immoral": ["phi đạo đức"],
  "decept": ["lừa dối"],
  "confuse": ["bối rối", "nhầm lẫn"],
  "downtown": ["trung tâm thành phố"],
  "properly": ["đúng cách"],
  "warranty": ["bảo hành"],
  "caliber": ["tầm cỡ", "đẳng cấp"],
  "ability": ["khả năng", "tầm cỡ"],
  "power": ["quyền lực"],
  "ancestor": ["tổ tiên"],
  "settle": ["ổn định"],
  "blacksmith": ["thợ rèn"],
  ...
  "shy": ["xấu hổ"],
  "insufficient = inadequate": ["không đủ"],
  "tamperproof": ["chống giả mạo"],
  "stated": ["đã nêu"],
  "appoint": ["bổ nhiệm"],
  ...
  "glowing evaluate": ["đánh giá tích cực"],
  "filing cabinet": ["tủ hồ sơ"],
  "upstair": ["trên lầu"],
  "messy": ["lộn xộn"],
  "bustling": ["nhộn nhịp", "sầm uất"],
  "seaport": ["cảng biển"],
  "ancient": ["cổ đại"],
  "fort": ["pháo đài"],
  "boast": ["tự hào", "khoe khoan"],
  "stroll": ["đi dạo"],
  "misty": ["sương mù"],
  "peaceful": ["yên bình"],
  ...
  "look into": ["xem xét", "nhìn vào"],
  "harassment": ["quấy rối"],
  "institute": ["viện nghiên cứu"],
  "spreading": ["lan rộng"],
  "disease": ["bệnh"],
  "infection": ["sự nhiễm trùng"],
  "contagion": ["sự lây lan", "sự lây nhiễm"],
  "cut back on": ["cắt giảm"],
  "for a limited period": ["trong khoảng thời gian giới hạn"],
  ...
  "suspend": ["đình chỉ"],
  "moving speech": ["bài phát biểu cảm động"],
  "escalate": ["leo thang"],
  "suspect": ["nghi nghờ", "nghi phạm"],
  "guilt": ["tội lỗi"],
  ...
  "tone": ["giọng điệu"],
  "symptom": ["triệu chứng"],
  "get medical attention": ["đến gặp bác sĩ"],
  "except": ["ngoại trừ"],
  "congestion": ["sự tắt nghẽn"],
  "fraud": ["gian lận"],
  "authorize": ["ủy quyền"],
  "realize": ["nhận ra"],
  "scammer": ["kẻ lừa đảo"],
  ...
  "literary": ["văn học"],
  "reside": ["cư trú"],
  "dismay": ["sự thất vọng", "sự kinh hoàng"],
  "toast": ["nướng"],
  ...
  "admission price": ["giá vé vào cửa"],
  "square": ["quãng trường", "hình vuông"],
  ...
  "integrate": ["tích hợp"],
  "tough": ["khó khăn"],
  "right-size": ["cắt giảm quy mô"],
  "reassess": ["đánh giá lại"],
  "exhaustive": ["đầy đủ", "kỹ lương"],
  "capitalize": ["tận dụng"],
  "fed up with": ["chán ngấy với"],
  "letting": ["cho phép"],
  "tragedy": ["thảm kịch"],
  "injure": ["làm bị thương"],
  "pull over": ["dừng xe bên đường", "tấp lề"],
  "incentive": ["khích lệ"],
  ...
  "advice column": ["chuyên mục tư vấn"],
  "addict": ["nghiện ngập"],
  "leadership": ["khả năng lãnh đạo"],
  "embrace": ["ôm"],
  "substitute": ["thay thế"],
  "eligible": ["đạt chuẩn", "đủ điều kiện"],
  "recognize": ["nhận ra", "ghi nhận"],
  "unsatisfactory": ["không đạt", "không thỏa đáng"],
  "property = estate": ["tài sản"],
  "urgent": ["cấp bách"],
  "freezer": ["tủ đông"],
  "mice": ["con chuột"],
  "cockroach": ["con gián"],
  ...
  "suppose": ["giả định"],
  "reflect": ["phản ánh"],
  "devise": ["thiết kế", "xây dựng"],
  "shortcoming": ["khuyết điểm"],
  "staff turnover": ["thay đổi nhân sự"],
  "manner": ["thái độ"],
  "scarf": ["khăn quàng cổ"],
  "price listed": ["giá niêm yết"],
